  ...
  const response = json(
    {
      ...
      message:
        "The Google login was started from a different browser profile, expired, or was restarted in another tab. Open AitherPath AI Assistant Agent and click Log in again in the same browser profile."
    },
    { status: 400 }
  );
